...
Supplementary Materials S1--S9 contain the full parameter tables, metric definitions, experiment designs and supplementary figures referenced in the text. Main-text figure files (workflow run 32040117179, 2026-08-17, pinned environment; archived in the code repository under \texttt{results/}): comparison\_configs.png (Fig.~\ref{fig:comparison}, comparison workflow), goldilocks\_alignment\_sweep.png (Fig.~\ref{fig:goldilocks}), alpha\_star\_sensitivity.png (Fig.~\ref{fig:alphastar}), echo\_chamber\_lifecycle.png (Fig.~\ref{fig:lifecycle}), aeci\_evolution.png (Fig.~\ref{fig:aeci}). Supplementary figure files: bubble\_timeseries.png (S1), transition\_timing.png (S2), spatial\_coverage.png (S3), periphery\_gap.png (S4), periphery\_gap\_evolution.png (S5), gap\_sweep.png (S6; run 32113082707), factor\_comparison.png (S7; run 32113892791).
