...
% NOTE (2026-08-17): the ΔUnmet and ΔAECI-Var columns of this table were computed
% on a 15-tick steady-state window while the raw means in the text use 75 ticks
% (window-mismatch bug, fixed on branch claude/ai-filter-bubbles-abm-fp40f6 of the
% model repo). Refresh those two columns — and the "seed-robust at a single
% alignment level only (α = 0.5)" sentence above — from the regenerated
% comparison_table.md after the workflow re-run. ΔSECI, ΔAECI-Err, ΔMAE and
% ΔPrecision are unaffected.
\begin{table}[h]
...
\midrule
0.0 & $+0.018\,[-0.028,\,+0.064]$ & $+0.022\,[-0.042,\,+0.087]$ & $+0.016\,[-0.023,\,+0.054]$ \\
0.1 & $+0.020\,[-0.026,\,+0.066]$ & $+0.006\,[-0.047,\,+0.060]$ & $+0.021\,[-0.008,\,+0.049]$ \\
0.2 & $+0.022\,[-0.018,\,+0.062]$ & $-0.011\,[-0.059,\,+0.037]$ & $+0.017\,[-0.015,\,+0.048]$ \\
0.3 & $+0.009\,[-0.039,\,+0.058]$ & $+0.028\,[-0.040,\,+0.096]$ & $+0.002\,[-0.027,\,+0.032]$ \\
0.4 & $+0.015\,[-0.032,\,+0.062]$ & $+0.035\,[-0.025,\,+0.094]$ & $-0.003\,[-0.030,\,+0.024]$ \\
0.5 & $+0.004\,[-0.048,\,+0.056]$ & $\mathbf{+0.036}\,[+0.006,\,+0.067]$ & $\mathbf{+0.035}\,[+0.004,\,+0.066]$ \\
0.6 & $-0.011\,[-0.057,\,+0.035]$ & $+0.061\,[-0.006,\,+0.128]$ & $+0.015\,[-0.022,\,+0.053]$ \\
0.7 & $\mathbf{-0.069}\,[-0.116,\,-0.021]$ & $-0.021\,[-0.085,\,+0.043]$ & $+0.018\,[-0.006,\,+0.042]$ \\
0.8 & $\mathbf{-0.080}\,[-0.127,\,-0.033]$ & $+0.039\,[-0.024,\,+0.102]$ & $+0.012\,[-0.015,\,+0.039]$ \\
0.9 & $\mathbf{-0.166}\,[-0.231,\,-0.101]$ & $-0.016\,[-0.090,\,+0.058]$ & $+0.012\,[-0.039,\,+0.064]$ \\
1.0 & $\mathbf{-0.182}\,[-0.250,\,-0.114]$ & $+0.030\,[-0.027,\,+0.087]$ & $-0.006\,[-0.058,\,+0.046]$ \\
\midrule
$\alpha$ & $\Delta$MAE & $\Delta$Unmet & $\Delta$Precision \\
\midrule
0.0 & $\mathbf{-0.080}\,[-0.116,\,-0.044]$ & $-0.680\,[-1.372,\,+0.012]$ & $\mathbf{+0.062}\,[+0.002,\,+0.121]$ \\
0.1 & $\mathbf{-0.087}\,[-0.116,\,-0.058]$ & $\mathbf{-1.180}\,[-2.134,\,-0.226]$ & $\mathbf{+0.070}\,[+0.017,\,+0.124]$ \\
0.2 & $\mathbf{-0.081}\,[-0.117,\,-0.044]$ & $-0.193\,[-1.036,\,+0.650]$ & $\mathbf{+0.064}\,[+0.007,\,+0.122]$ \\
0.3 & $\mathbf{-0.091}\,[-0.129,\,-0.054]$ & $-0.297\,[-0.946,\,+0.353]$ & $\mathbf{+0.069}\,[+0.009,\,+0.130]$ \\
0.4 & $\mathbf{-0.077}\,[-0.118,\,-0.036]$ & $-0.457\,[-1.010,\,+0.097]$ & $\mathbf{+0.071}\,[+0.009,\,+0.133]$ \\
0.5 & $\mathbf{-0.105}\,[-0.140,\,-0.071]$ & $-0.163\,[-0.515,\,+0.188]$ & $\mathbf{+0.081}\,[+0.022,\,+0.140]$ \\
0.6 & $\mathbf{-0.130}\,[-0.163,\,-0.098]$ & $-0.157\,[-0.541,\,+0.228]$ & $\mathbf{+0.093}\,[+0.035,\,+0.151]$ \\
0.7 & $\mathbf{-0.123}\,[-0.161,\,-0.085]$ & $-0.403\,[-0.847,\,+0.040]$ & $+0.057\,[-0.008,\,+0.122]$ \\
0.8 & $\mathbf{-0.116}\,[-0.163,\,-0.068]$ & $\mathbf{-0.760}\,[-1.420,\,-0.100]$ & $\mathbf{+0.097}\,[+0.030,\,+0.164]$ \\
0.9 & $\mathbf{-0.154}\,[-0.214,\,-0.095]$ & $\mathbf{-4.457}\,[-6.040,\,-2.873]$ & $\mathbf{+0.302}\,[+0.204,\,+0.399]$ \\
1.0 & $\mathbf{-0.156}\,[-0.203,\,-0.109]$ & $\mathbf{-4.163}\,[-5.482,\,-2.845]$ & $\mathbf{+0.276}\,[+0.179,\,+0.373]$ \\
\botrule
\end{tabular}
\end{table}
